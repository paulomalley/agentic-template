...
6. **Sign-Off Integrity** â€” when requesting sign-off, include a specific summary of what's being approved and at least one concrete question/decision point.
7. **Post-Implementation Gate** â€” before presenting code, verify compilation and linting, and update the project's changelog if one exists.
